...
import edu.stanford.protege.server.admin.exception.NonMatchingPasswordException;
...
public class UserDialogPanel extends JPanel implements VerifiedInputEditor {
    private static final long serialVersionUID = 7023591256822820509L;
    ...
    private void initInputFields() {
        ...
        password.setBorder(UiUtils.MATTE_BORDER);
        passwordConf.setBorder(UiUtils.MATTE_BORDER);
