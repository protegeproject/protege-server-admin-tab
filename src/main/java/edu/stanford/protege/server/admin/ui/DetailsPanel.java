...
import edu.stanford.protege.server.admin.model.Detail;
...
public class DetailsPanel extends JPanel implements Disposable {
    private static final long serialVersionUID = 8517092710658812145L;
    ...
    private JPanel getDetails(String header, List<Detail> details) {
        ...
        userDetailsPanel.setBorder(UiUtils.EMPTY_BORDER);
