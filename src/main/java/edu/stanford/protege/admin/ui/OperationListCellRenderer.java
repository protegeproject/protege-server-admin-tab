...
public class OperationListCellRenderer extends DefaultListCellRenderer {
    ...
    private Icon getIcon(OperationType type) {
        switch(type) {
            case READ:
                return GuiUtils.getIcon("permission-read.png", 20, 20);
            case WRITE:
                return GuiUtils.getIcon("permission-write.png", 20, 20);
            case EXECUTE:
                return GuiUtils.getIcon("permission-execute.png", 20, 20);
            default:
